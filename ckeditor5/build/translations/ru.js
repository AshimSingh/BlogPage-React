;(function (e) {
    ...
    t.dictionary = Object.assign(t.dictionary || {}, {
        ...
        'Editor editing area: %0':
            'Область редактирования редактора: %0',
        ...
        'Insert paragraph after block':
            'Вставить параграф после блока',
        'Insert paragraph before block':
            'Вставить параграф перед блоком',
        ...
        'Paste the media URL in the input.':
            'Вставьте URL медиа в поле ввода.',
        ...
        'Table alignment toolbar':
            'Панель инструментов выравнивания таблицы',
        ...
        'This link has no URL':
            'Для этой ссылки не установлен адрес URL',
        'This media URL is not supported.':
            'Этот URL медиа не поддерживается.',
