;(function (e) {
    ...
    a.dictionary = Object.assign(a.dictionary || {}, {
        ...
        'Align cell text to the bottom':
            'Aliñar o texto da cela á base',
        'Align cell text to the center':
            'Aliñar o texto da cela ao centro',
        'Align cell text to the left':
            'Aliñar o texto da cela á esquerda',
        'Align cell text to the middle':
            'Aliñar o texto da cela ao medio',
        'Align cell text to the right':
            'Aliña o texto da cela á dereita',
        'Align cell text to the top':
            'Aliñar o texto da cela á parte superior',
        ...
        'Change image text alternative':
            'Cambiar o texto alternativo da imaxe',
        ...
        'Insert paragraph after block':
            'Inserir parágrafo após o bloque',
        'Insert paragraph before block':
            'Inserir parágrafo antes do bloque',
        ...
        'Paste the media URL in the input.':
            'Pegue o URL do medio na entrada.',
        ...
        'Table cell text alignment':
            'Aliñamento do texto das celas da táboa',
        ...
        'Toggle the circle list style':
            'Alternar o estilo da lista «círculos»',
        ...
        'Toggle the disc list style':
            'Alternar o estilo da lista «discos»',
        ...
        'Toggle the square list style':
            'Alternar o estilo da lista «cadrados»',
