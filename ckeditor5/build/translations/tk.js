;(function (e) {
    ...
    a.dictionary = Object.assign(a.dictionary || {}, {
        ...
        'Align cell text to the bottom':
            'Öýjük tekstini aşagyna deňleşdiriň',
        'Align cell text to the center':
            'Öýjük tekstini merkeze deňleşdiriň',
        'Align cell text to the left':
            'Öýjük tekstini çepe deňleşdiriň',
        'Align cell text to the middle':
            'Öýjük tekstini ortasyna deňleşdiriň',
        'Align cell text to the right':
            'Öýjük tekstini saga deňleşdiriň',
        'Align cell text to the top':
            'Öýjük tekstini ýokarsyna deňleşdiriň',
        'Align table to the left': 'Tablisany çepe deňleşdiriň',
        'Align table to the right':
            'Tablisany sag tarapa deňleşdiriň',
        ...
        'Table alignment toolbar':
            'Tablisa deňleşdirmek gurallar paneli',
