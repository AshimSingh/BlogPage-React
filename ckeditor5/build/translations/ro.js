;(function (e) {
    ...
    t.dictionary = Object.assign(t.dictionary || {}, {
        ...
        'Align cell text to the bottom':
            'Alinează textul celulei jos',
        'Align cell text to the center':
            'Alinează textul celulei la centru',
        'Align cell text to the left':
            'Alinează textul celulei la stânga',
        'Align cell text to the middle':
            'Alinează textul celulei la mijloc',
        'Align cell text to the right':
            'Alinează textul celulei la dreapta',
        ...
        Clear: 'Ștergere',
        'Click to edit block':
            'Faceți clic pentru a edita întreg blocul',
        Code: 'Cod',
        Color: 'Culoare',
        ...
        'Editor contextual toolbar':
            'Bară contextuală de instrumente editor',
        'Editor editing area: %0': 'Zonă editare editor: %0',
        'Editor toolbar': 'Bară editor',
        'Enter image caption':
            'Introdu titlul descriptiv al imaginii',
        ...
        'Horizontal text alignment toolbar':
            'Toolbar aliniere text orizontală',
        ...
        'Insert paragraph after block':
            'Inserează un paragraf după bloc',
        ...
        'Open media in new tab':
            'Deschideți conținutul media într-o filă nouă',
        Orange: 'Portocaliu',
        Original: 'Original',
        Outset: 'Elimină',
        Padding: 'Spațiere',
        ...
        'Table cell text alignment':
            'Alinierea textului celulei tabelei',
        ...
        'This media URL is not supported.':
            'Acest URL media nu este suportat.',
        ...
        'Toggle the circle list style':
            'Comutați stilul la lista cu cercuri',
        'Toggle the decimal list style':
            'Comutați stilul la lista cu numere',
        ...
        'Toggle the disc list style':
            'Comutați stilul la lista cu discuri',
        ...
        'Toggle the square list style':
            'Comutați stilul la lista cu pătrate',
        ...
        'Vertical text alignment toolbar':
            'Toolbar aliniere text verticală',
        White: 'Alb',
