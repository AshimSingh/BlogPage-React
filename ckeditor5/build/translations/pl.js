;(function (e) {
    ...
    a.dictionary = Object.assign(a.dictionary || {}, {
        ...
        'Align cell text to the bottom':
            'Wyrównaj tekst w komórce do dołu',
        'Align cell text to the center':
            'Wyrównaj tekst w komórce do środka',
        'Align cell text to the left':
            'Wyrównaj tekst w komórce do lewej',
        'Align cell text to the middle':
            'Wyrównaj tekst w komórce do środka',
        'Align cell text to the right':
            'Wyrównaj tekst w komórce do prawej',
        'Align cell text to the top':
            'Wyrównaj tekst w komórce do góry',
        ...
        'Editor block content toolbar':
            'Pasek zadań treści blokowej edytora',
        'Editor contextual toolbar':
            'Kontekstowy pasek zadań edytora',
        ...
        'Paste the media URL in the input.':
            'Wklej adres URL mediów do pola.',
        ...
        'Table cell text alignment':
            'Wyrównanie tekstu komórki tabeli',
        ...
        'Toggle the circle list style':
            'Włącz/wyłącz listę w stylu „kółko”',
        ...
        'Toggle the disc list style':
            'Włącz/wyłącz listę w stylu „dysk”',
        ...
        'Toggle the square list style':
            'Włącz/wyłącz listę w stylu „kwadrat”',
