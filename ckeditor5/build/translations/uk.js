;(function (e) {
    ...
    t.dictionary = Object.assign(t.dictionary || {}, {
        ...
        'Editor contextual toolbar':
            'Контекстна панель інструментів редактора',
        'Editor editing area: %0':
            'Область редагування редактора: %0',
        ...
        'Table alignment toolbar':
            'Панель інструментів вирівнювання таблиці',
        ...
        'This media URL is not supported.':
            'Даний медіа URL не підтримується.',
        ...
        'Toggle the circle list style':
            'Перемкнути круговий стиль списку',
        'Toggle the decimal list style':
            'Перемкнути десятковий стиль списку',
        ...
        'Toggle the disc list style':
            'Перемкнути дисковий стиль списку ',
        ...
        'Toggle the square list style':
            'Перемкнути квадратний стиль списку',
