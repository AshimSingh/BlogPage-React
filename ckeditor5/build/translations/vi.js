;(function (n) {
    ...
    t.dictionary = Object.assign(t.dictionary || {}, {
        ...
        'Align cell text to the left':
            'Căn chỉnh văn bản trong ô về bên trái',
        'Align cell text to the middle':
            'Căn chỉnh văn bản trong ô vào giữa',
        'Align cell text to the right':
            'Căn chỉnh văn bản trong ô về bên phải',
        'Align cell text to the top':
            'Căn chỉnh văn bản trong ô lên trên cùng',
        ...
        'Editor block content toolbar':
            'Thanh công cụ chỉnh sửa khối nội dung',
        'Editor contextual toolbar':
            'Thanh công cụ chỉnh sửa theo ngữ cảnh',
        'Editor editing area: %0':
            'Vùng chỉnh sửa của trình chỉnh sửa: %0',
        ...
        'Open media in new tab':
            'Mở nội dung nghe nhìn trong tab mới',
        Orange: 'Cam',
        Original: 'Nguyên bản',
        Outset: 'Dạng nổi',
        Padding: 'Cách lề',
        ...
        'Resize image to the original size':
            'Chỉnh về ảnh kích cỡ nguyên gốc',
        ...
        'Toggle the circle list style':
            'Bật/tắt kiểu danh sách dạng vòng tròn',
        ...
        'Toggle the disc list style':
            'Bật/tắt kiểu danh sách dạng đĩa',
        ...
        'Toggle the square list style':
            'Bật/tắt kiểu danh sách dạng vuông',
        ...
        'Type or paste your content here.':
            'Nhập hoặc dán nội dung tại đây',
