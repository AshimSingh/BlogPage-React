;(function (i) {
    ...
    e.dictionary = Object.assign(e.dictionary || {}, {
        ...
        'Align cell text to the bottom':
            'Lygiuoti langelio tekstą apačioje',
        'Align cell text to the center':
            'Lygiuoti langelio tekstą centre',
        'Align cell text to the left':
            'Lygiuoti langelio tekstą kairėje',
        'Align cell text to the middle':
            'Lygiuoti langelio tekstą viduryje',
        'Align cell text to the right':
            'Lygiuoti langelio tekstą dešinėje',
        'Align cell text to the top':
            'Lygiuoti langelio tekstą viršuje',
        ...
        'Change image text alternative':
            'Pakeisti vaizdo alternatyvųjį tekstą',
        'Choose heading': 'Pasirinkite antraštę',
        Circle: 'Apskritimas',
        Clear: 'Išvalyti',
        'Click to edit block':
            'Spustelėkite norėdami redaguoti bloką',
        Code: 'Kodas',
        Color: 'Spalva',
        ...
        'Editor contextual toolbar':
            'Redaktoriaus kontekstinė įrankių juosta',
        'Editor editing area: %0':
            'Redaktoriaus redagavimo sritis: %0',
        ...
        'Table cell text alignment':
            'Lentelės langelio teksto lygiavimas',
        ...
        'This media URL is not supported.':
            'Šis media URL yra nepalaikomas.',
        ...
        'Toggle the circle list style':
            'Perjungti ovalų sąrašo stilių',
        'Toggle the decimal list style':
            'Perjungti dešimtainį sąrašo stilių',
        ...
        'Toggle the disc list style':
            'Perjungti diskinį sąrašo stilių',
        ...
        'Toggle the square list style':
            'Perjungti kvadratinį sąrašo stilių',
