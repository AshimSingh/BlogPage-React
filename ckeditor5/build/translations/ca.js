;(function (e) {
    ...
    a.dictionary = Object.assign(a.dictionary || {}, {
        ...
        'Image resize list':
            'Llista de redimensionament de la imatge',
        ...
        'Insert image via URL':
            "Introduir la imatge mitjançant l'URL",
        'Insert media': 'Introduir multimèdia',
        'Insert paragraph after block':
            'Inserir un paràgraf després del bloc',
        'Insert paragraph before block':
            'Inserir un paràgraf abans del bloc',
        ...
        'Split cell horizontally':
            'Dividir la cel·la horitzontalment',
        ...
        'Table alignment toolbar':
            "Barra d'eines d'alineació de taules",
        ...
        'Toggle the circle list style':
            "Canviar l'estil de llista de cercles",
        'Toggle the decimal list style':
            "Canviar l'estil de llista decimal",
        ...
        'Toggle the disc list style':
            "Canviar l'estil de llista de discs",
        ...
        'Toggle the square list style':
            "Canviar l'estil de llista quadrada",
